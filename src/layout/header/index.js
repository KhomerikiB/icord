        ...
        <div className=" home-row">
          ...
          {isIndex ? (
            <p className="main-header__text home-col-2">
              The 15th Annual INTERNATIONAL CONFERENCE ON RARE DISEASES AND ORPHAN DRUGS (ICORD) Meeting arranged in collaboration with the GEORGIAN FOUNDATION FOR GENETIC AND RARE DISEASES (GeRaD)
            </p>
          ) : (
